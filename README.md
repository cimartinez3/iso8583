[![Moov Banner Logo](https://user-images.githubusercontent.com/20115216/104214617-885b3c80-53ec-11eb-8ce0-9fc745fb5bfc.png)](https://github.com/cimartinez3)

<p align="center">
  <a href="https://github.com/cimartinez3/iso8583/tree/master/docs">Project Documentation</a>
  ·
...
[![GoDoc](https://godoc.org/github.com/cimartinez3/iso8583?status.svg)](https://godoc.org/github.com/cimartinez3/iso8583)
[![Build Status](https://github.com/cimartinez3/iso8583/workflows/Go/badge.svg)](https://github.com/cimartinez3/iso8583/actions)
[![Coverage Status](https://codecov.io/gh/cimartinez3/iso8583/branch/master/graph/badge.svg)](https://codecov.io/gh/cimartinez3/iso8583)
[![Go Report Card](https://goreportcard.com/badge/github.com/cimartinez3/iso8583)](https://goreportcard.com/report/github.com/cimartinez3/iso8583)
[![Repo Size](https://img.shields.io/github/languages/code-size/cimartinez3/iso8583?label=project%20size)](https://github.com/cimartinez3/iso8583)
[![Apache 2 License](https://img.shields.io/badge/license-Apache2-blue.svg)](https://raw.githubusercontent.com/cimartinez3/iso8583/master/LICENSE)
[![Slack Channel](https://slack.moov.io/badge.svg?bg=e01563&fgColor=fffff)](https://slack.moov.io/)
[![GitHub Stars](https://img.shields.io/github/stars/cimartinez3/iso8583)](https://github.com/cimartinez3/iso8583)
...
`iso8583` CLI is available as downloadable binaries from the [releases page](https://github.com/cimartinez3/iso8583/releases/latest) for MacOS, Windows and Linux.

Here is an example how to install MacOS version:

```
wget -O ./iso8583 https://github.com/cimartinez3/iso8583/releases/download/v0.4.6/iso8583_0.4.6_darwin_amd64 && chmod +x ./iso8583
```
...
## Getting help
 ...
 channel | info
 ------- | -------
[Project Documentation](https://github.com/cimartinez3/iso8583/tree/master/docs) | Our project documentation available online.
Twitter [@moov](https://twitter.com/moov)	| You can follow Moov.io's Twitter feed to get updates on our project(s). You can also tweet us questions or just share blogs or stories.
[GitHub Issue](https://github.com/cimartinez3/iso8583/issues/new) | If you are able to reproduce a problem please open a GitHub Issue under the specific project that caused the error.
[cimartinez3 slack](https://slack.moov.io/) | Join our slack channel (`#iso8583`) to have an interactive discussion about the development of the project.
...
Please review our [Contributing guide](CONTRIBUTING.md) and [Code of Conduct](CODE_OF_CONDUCT.md) to get started! Check out our [issues for first time contributors](https://github.com/cimartinez3/iso8583/contribute) for something to help out with.
...
- [Moov ACH](https://github.com/cimartinez3/ach) provides ACH file generation and parsing, supporting all Standard Entry Codes for the primary method of money movement throughout the United States.

- [Moov Watchman](https://github.com/cimartinez3/watchman) offers search functions over numerous trade sanction lists from the United States and European Union.

- [Moov Fed](https://github.com/cimartinez3/fed) implements utility services for searching the United States Federal Reserve System such as ABA routing numbers, financial institution name lookup, and FedACH and Fedwire routing information.

- [Moov Wire](https://github.com/cimartinez3/wire) implements an interface to write files for the Fedwire Funds Service, a real-time gross settlement funds transfer system operated by the United States Federal Reserve Banks.

- [Moov ImageCashLetter](https://github.com/cimartinez3/imagecashletter) implements Image Cash Letter (ICL) files used for Check21, X.9 or check truncation files for exchange and remote deposit in the U.S.

- [Moov Metro2](https://github.com/cimartinez3/metro2) provides a way to easily read, create, and validate Metro 2 format, which is used for consumer credit history reporting by the United States credit bureaus.
