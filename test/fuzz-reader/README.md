...
Then using the [volume's mount path](https://github.com/cimartinez3/infra/blob/master/lib/apps/10-iso8583fuzz.yml#L43) select any crasher files.

```
$ kubectl exec -n apps iso8583fuzz-6bbdc574f5-pl2zm -- ls -la /go/src/github.com/cimartinez3/iso8583/test/fuzz-reader/crashers/
total 28
...
$ kubectl cp 'apps/iso8583fuzz-6bbdc574f5-pl2zm:/go/src/github.com/cimartinez3/iso8583/test/fuzz-reader/crashers/<file>' ./
```
